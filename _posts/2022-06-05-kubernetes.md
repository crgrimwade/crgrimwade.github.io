...
```
  Kubernetes
    Pi Cluster
      Install 64bit Rasbian (Short Method)
      Reboot in the Pi and login and as root
      sudo su - #Flush and setup iptables
      sudo iptables -F 
      sudo update-alternatives --set ip6tables /usr/sbin/ip6tables-legacy
      sudo update-alternatives --set iptables /usr/sbin/iptables-legacy 
      reboot
      ... and repeat for each pi
      Master
        curl -sfL https://get.k3s.io | K3S_KUBECONFIG_MODE="644" sh -s -
        cat /var/lib/rancher/k3s/server/node-token
      Worker
        curl -sfL https://get.k3s.io | K3S_TOKEN="token" K3S_URL="https://master-ip:6443" K3S_NODE_NAME="kube-x" sh -
        curl -sfL https://get.k3s.io | K3S_TOKEN="K1072e856b2ea1d5923f06e82af71265015f1a6f4b924842073fdd1f36c36fe3e05::server:74f0901a4cbb889c73c91d04264b0112" K3S_URL="https://192.168.1.42:6443" K3S_NODE_NAME="kube-2" sh -
        curl -sfL https://get.k3s.io | K3S_TOKEN="K1072e856b2ea1d5923f06e82af71265015f1a6f4b924842073fdd1f36c36fe3e05::server:74f0901a4cbb889c73c91d04264b0112" K3S_URL="https://192.168.1.42:6443" K3S_NODE_NAME="kube-3" sh -
      Rancher
    ...
    Kubernetes Stuff
      ...
      using github
        authenticate
          create github access token - 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
          export CR_PAT=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
